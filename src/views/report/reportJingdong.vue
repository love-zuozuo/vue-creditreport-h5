<template>
  <section class="main unselect">
    ...
    <p class="header-title">我的京东报告详情</p>
      ...
      <section class="card baseInfo">
        ...
        <van-row type="flex" class="info-content">
          <van-col span="24">
            <div>
              ...
              {{dataInfo.basic.loginName}}
              <img
                v-if="dataInfo.basic.isTrueName==1"
        ...
        <van-row type="flex" class="info-content">
          <van-col span="12">
            ...
            <div>{{dataInfo.basic.xiaobai}}</div>
          </van-col>
          <van-col span="12">
            <label class="fr5">白条总额度</label>
            <div>{{dataInfo.basic.btCreditLimit}}</div>
          </van-col>
        </van-row>
        <van-row type="flex" class="info-content">
          <van-col span="12">
            <label class="fr5">白条逾期金额</label>
            <div>{{dataInfo.basic.btJtDelinquencyBalance}}</div>
          </van-col>
          <van-col span="12">
            <label class="fr5">近半年消费次数</label>
            <div>{{dataInfo.basic.buyTimesSix}}</div>
          </van-col>
        </van-row>
        <van-row type="flex" class="info-content">
          <van-col span="12">
            <label class="fr5">近半年消费总额</label>
            <div>{{dataInfo.basic.buyAmountSix}}</div>
          </van-col>
          <van-col span="12">
            <label class="fr5">常用收货城市</label>
            <div>{{dataInfo.basic.useCitySixMouth}}</div>
          </van-col>
        </van-row>
        <van-row type="flex" class="info-content">
          <van-col span="24">
            <label class="fr5">第一笔消费时间</label>
            <div>{{dataInfo.basic.firstBuyTime}}</div>
          </van-col>
        </van-row>
      </section>
      <!-- 常用收货地址 -->
